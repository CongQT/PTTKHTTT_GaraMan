 ...
 * @author 84382
 */
public class NhanVienKho096 extends NhanVien096{
    private int NhanVien096ThanhVien096id;

    public NhanVienKho096(int NhanVien096ThanhVien096id, int thanhvien096id, String vitri) {
        super(thanhvien096id, vitri);
        this.NhanVien096ThanhVien096id = NhanVien096ThanhVien096id;
    }

    public NhanVienKho096(int NhanVien096ThanhVien096id, int thanhvien096id, String vitri, int id, String username, String matKhau, String hoTen, String diaChi, String sdt, String email, String vaiTro) {
